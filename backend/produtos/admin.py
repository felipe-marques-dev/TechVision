...
class ProdutoAdmin(admin.ModelAdmin):
    list_display = ('name','product_id','categoria_id', 'sub_category','description', 'estoque', 'price', 'promotion','foto_1', 'foto_2', 'foto_3', 'foto_4')  # Campos que serão exibidos na lista de produtos
